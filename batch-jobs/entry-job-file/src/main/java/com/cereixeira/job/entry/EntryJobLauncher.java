...
public class EntryJobLauncher implements IEntryJobLauncher {
    private Logger logger = LogManager.getLogger(EntryJobLauncher.class);
    @Autowired
    @Qualifier(EntryJobBeanName.ENTRY_SIMPLE_JOB_LAUNCHER)
    private org.springframework.batch.core.launch.JobLauncher entrySimpleJobLauncher;

    @Autowired
    @Qualifier(EntryJobBeanName.ENTRY_JOB)
